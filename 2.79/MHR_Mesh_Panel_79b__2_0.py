...
class RenameGenericPhysics(bpy.types.Operator):
    ...
    bl_label = "Rename Generic Phyiscs"
...
def register():
    bpy.utils.register_class(ScaleRotate)
    bpy.utils.register_class(RenameVG)
    bpy.utils.register_class(RenameBreasts)
    bpy.utils.register_class(RenameGenericPhysics)
    bpy.utils.register_class(MHRPanel)

def unregister():
    bpy.utils.unregister_class(ScaleRotate)
    bpy.utils.unregister_class(RenameVG)
    bpy.utils.unregister_class(RenameBreasts)
